...
public class LegacyGameGUI extends Applet implements Runnable {
    ...
    private void loadAllGameGraphics(MediaTracker tracker) {
        xMark = getImage(this.getClass().getResource("/xMark.jpg"));
        oMark = getImage(this.getClass().getResource("/oMark.jpg"));
        filledOMark = getImage(this.getClass().getResource("/oMarkFilled.jpg"));
        emptySquare = getImage(this.getClass().getResource("/emptySquare.jpg"));
        winningImage = getImage(this.getClass().getResource("/win.jpg"));
        losingImage = getImage(this.getClass().getResource("/lose.jpg"));
        yourTurnImage = getImage(this.getClass().getResource("/yourTurn.jpg"));
        newGameImage = getImage(this.getClass().getResource("/newgame.jpg"));
